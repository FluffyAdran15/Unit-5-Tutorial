...
window.addEventListener("load", function() {
	//retrieve the field pairs from the URL
...
function validateCVC() {
	...
	var dreditCard = document.querySelectorAll('input[name="credit"]:checked').value;
...
function luhn(idNum) {
	...
	//return whether the sum of the digits is divisble by 10
